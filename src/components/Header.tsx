...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-[var(--line)] bg-[var(--header-bg)] px-4">
      <nav className="page-wrap flex items-center justify-between gap-x-3 gap-y-2 py-3 sm:py-4">
      ...
      <div className=" flex w-full flex-wrap items-center gap-x-4 gap-y-1 pb-1 text-sm font-semibold  sm:w-auto sm:flex-nowrap sm:pb-0">
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:ml-0 sm:gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden rounded-xs p-2 text-[var(--sea-ink-soft)] transition hover:bg-[var(--link-bg-hover)] hover:text-[var(--sea-ink)] sm:block"
          >
            <span className="sr-only">Follow ZamSign on X</span>
           <svg viewBox="1 0 21 21" aria-hidden="true" width="24" height="24">
            <path
              fill="currentColor"
          ...
          <a
            ...
            className="hidden rounded-xs p-2 text-[var(--sea-ink-soft)] transition hover:bg-[var(--link-bg-hover)] hover:text-[var(--sea-ink)] sm:block"
          >
            <span className="sr-only">Go to ZamSign on Tiktok</span>
