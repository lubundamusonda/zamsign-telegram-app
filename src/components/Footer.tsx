    ...
    <footer className="mt-20 border-t border-[var(--line)] px-4 pb-14 pt-10 text-[var(--sea-ink-soft)]">
      <div className="page-wrap flex flex-col items-center justify-center gap-4 text-center sm:flex-row sm:text-left">
        <p className="m-0 text-sm">
          &copy; {year} ZamSign Ltd. All rights reserved.
        </p>
      </div>
      <div className="mt-4 flex justify-center gap-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="rounded-sm p-2 text-[var(--sea-ink-soft)] transition hover:bg-[var(--link-bg-hover)] hover:text-[var(--sea-ink)]"
        >
          <span className="sr-only">Follow ZamSign on Telegram</span>
          <svg viewBox="1 0 21 21" aria-hidden="true" width="32" height="32">
            <path
              fill="currentColor"
        ...
        <a
          ...
          className="rounded-sm p-2 text-[var(--sea-ink-soft)] transition hover:bg-[var(--link-bg-hover)] hover:text-[var(--sea-ink)]"
        >
          <span className="sr-only">Go to ZamSign Tiktok</span>
