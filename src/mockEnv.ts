    ...
    mockTelegramEnv({
      ...
      launchParams: new URLSearchParams([
        ...
        ['tgWebAppData', new URLSearchParams([
          ...
          ['signature', self.crypto.randomUUID()],
          ['user', JSON.stringify({
                        id: import.meta.env.MOCK_USER_ID || 999,
                        first_name: import.meta.env.MOCK_FIRST_NAME || 'RYAN',
                        last_name: import.meta.env.MOCK_LAST_NAME || 'SMITH',
                        photo_url: 'https://t.me/i/userpic/320/it5N-6kWcwjFkjS2ju7doeoXxu5MTcD-OjMf614ZB6O_kE_ycZm8Omc4lfLgqHE6.svg',
                         })],
        ]).toString()],
        ['tgWebAppVersion', '8.4'],
